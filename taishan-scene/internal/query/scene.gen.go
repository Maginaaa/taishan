...
func newScene(db *gorm.DB, opts ...gen.DOOption) scene {
	...
	_scene.ID = field.NewInt32(tableName, "id")
	_scene.PlanID = field.NewInt32(tableName, "plan_id")
	_scene.Sort = field.NewInt32(tableName, "sort")
	_scene.SceneType = field.NewInt32(tableName, "scene_type")
	_scene.SceneName = field.NewString(tableName, "scene_name")
	_scene.ExportInfo = field.NewString(tableName, "export_info")
	_scene.Disabled = field.NewBool(tableName, "disabled")
	_scene.CreateUserID = field.NewInt32(tableName, "create_user_id")
	_scene.UpdateUserID = field.NewInt32(tableName, "update_user_id")
	_scene.CreateTime = field.NewTime(tableName, "create_time")
	_scene.UpdateTime = field.NewTime(tableName, "update_time")
	_scene.IsDelete = field.NewBool(tableName, "is_delete")
...
type scene struct {
	...
	ALL          field.Asterisk
	ID           field.Int32  // 场景id
	PlanID       field.Int32  // 场景id
	Sort         field.Int32  // 排序
	SceneType    field.Int32  // 场景类型
	SceneName    field.String // 场景名
	ExportInfo   field.String // 导出数据信息
...
func (s *scene) updateTableName(table string) *scene {
	...
	s.PlanID = field.NewInt32(table, "plan_id")
	s.Sort = field.NewInt32(table, "sort")
	s.SceneType = field.NewInt32(table, "scene_type")
	s.SceneName = field.NewString(table, "scene_name")
	s.ExportInfo = field.NewString(table, "export_info")
...
func (s *scene) fillFieldMap() {
	...
	s.fieldMap["export_info"] = s.ExportInfo
