...
func newPlan(db *gorm.DB, opts ...gen.DOOption) plan {
	...
	_plan.ServerInfo = field.NewString(tableName, "server_info")
	...
	_plan.Tag = field.NewString(tableName, "tag")
...
func (p *plan) updateTableName(table string) *plan {
	...
	p.ServerInfo = field.NewString(table, "server_info")
...
func (p *plan) fillFieldMap() {
	...
	p.fieldMap["server_info"] = p.ServerInfo
