        ...
        <ElRow :gutter="20" justify="space-between">
          <ElCol :xl="12" :lg="12" :md="12" :sm="24" :xs="24">
            <div class="flex items-center">
              <img
                src="https://s1-imfile.feishucdn.com/static-resource/v1/v3_007c_e9a634fe-aa21-40f1-9043-04e57eeba55g~?image_size=noop&cut_type=&quality=&format=png&sticker_format=.webp"
                alt=""
                class="w-70px h-70px rounded-[50%] mr-20px"
              />
              <div>
                <div class="text-20px">
                  {{ t('workplace.goodMorning') }}，熊林涛，{{ t('workplace.happyDay') }}
                </div>
