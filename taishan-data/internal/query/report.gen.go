...
func newReport(db *gorm.DB, opts ...gen.DOOption) report {
	...
	_report.EngineList = field.NewString(tableName, "engine_list")
	_report.Concurrency = field.NewInt32(tableName, "concurrency")
	_report.PressResult = field.NewString(tableName, "press_result")
	...
	_report.Rps = field.NewInt32(tableName, "rps")
...
type report struct {
	...
	EngineList   field.String // 施压机ip列表
	Concurrency  field.Int32  // 起始并发数
	PressResult  field.String // 压测聚合结果
...
func (r *report) updateTableName(table string) *report {
	...
	r.EngineList = field.NewString(table, "engine_list")
	r.Concurrency = field.NewInt32(table, "concurrency")
	r.PressResult = field.NewString(table, "press_result")
	...
	r.Rps = field.NewInt32(table, "rps")
...
func (r *report) fillFieldMap() {
	...
	r.fieldMap["press_result"] = r.PressResult
